...
from data import get_movie_info  # keep if you still want to backfill cache

main_bp = Blueprint("main", __name__)

# ✅ Absolute paths so Flask never gets confused
